...
test_that("basic test for reading test parameters",{
  ...
  expect_equal(length(read_parameters_result), 12)
...
test_that("basic test for reading coverage table from database",{
  ...
  read_coverage_table_result <- read_coverage_table("test_coverage", conn_hive)
  ...
  expect_equal(read_coverage_table_result[2,"sample_name"], coverage_table[2,"sample_name"])
  expect_equal(read_coverage_table_result[2,"target_id"], coverage_table[2,"target_id"])
  expect_equal(read_coverage_table_result[2,"chr"], coverage_table[2,"chr"])
  expect_equal(read_coverage_table_result[2,"pos_min"], coverage_table[2,"pos_min"])
