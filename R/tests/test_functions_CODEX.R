...
test_that("eight samples from CODEX demo object",{
  ...
  #expect_equal(round(normObj1_result$AIC[1], digits=2), 42924.11)
  #expect_equal(round(normObj1_result$AIC[2], digits=2), 42894.16)
  #expect_equal(round(normObj1_result$AIC[3], digits=2), 42863.36)
  #expect_equal(round(normObj1_result$AIC[4], digits=2), 42834.58)
  #expect_equal(round(normObj1_result$AIC[5], digits=2), 42802.62)
  expect_equal(length(normObj1_result$BIC), 5)
  #expect_equal(round(normObj1_result$BIC[1], digits=2), 42889.57)
  #expect_equal(round(normObj1_result$BIC[2], digits=2), 42825.07)
  #expect_equal(round(normObj1_result$BIC[3], digits=2), 42759.73)
  #expect_equal(round(normObj1_result$BIC[4], digits=2), 42696.42)
  #expect_equal(round(normObj1_result$BIC[5], digits=2), 42629.91)
  expect_equal(length(normObj1_result$RSS), 5)
  #expect_equal(round(normObj1_result$RSS[1], digits=6), 7.375000)
  #expect_equal(round(normObj1_result$RSS[2], digits=6), 5.234375)
  #expect_equal(round(normObj1_result$RSS[3], digits=6), 3.921875)
  #expect_equal(round(normObj1_result$RSS[4], digits=6), 0.062500)
  #expect_equal(round(normObj1_result$RSS[5], digits=6), 0.000000)
})
...
test_that("eight samples from CODEX demo object",{
  ...
  #expect_equal(round(normObj2_result$AIC[1], digits=2), 42820.72)
  #expect_equal(round(normObj2_result$AIC[2], digits=2), 42794.51)
  #expect_equal(round(normObj2_result$AIC[3], digits=2), 42780.01)
  #expect_equal(length(normObj2_result$BIC), 3)
  #expect_equal(round(normObj2_result$BIC[1], digits=2), 42786.17)
  #expect_equal(round(normObj2_result$BIC[2], digits=2), 42725.42)
  #expect_equal(round(normObj2_result$BIC[3], digits=2), 42676.39)
  #expect_equal(length(normObj2_result$RSS), 3)
  #expect_equal(round(normObj2_result$RSS[1], digits=4), 453.0938)
  #expect_equal(round(normObj2_result$RSS[2], digits=4), 411.1719)
  #expect_equal(round(normObj2_result$RSS[3], digits=4), 344.2812)
})
